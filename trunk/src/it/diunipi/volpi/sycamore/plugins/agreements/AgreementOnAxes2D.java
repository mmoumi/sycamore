...
public class AgreementOnAxes2D extends AgreementImpl<Point2D>
{
	/*
	 * (non-Javadoc)
	 * 
	...
	{
		return "Agreement on all axes. This means that x and y axes are the same for all local coordinate systems, and that they are never flipped with respect to each other. However, the measure unit cannot be the same for all coordinate systems.";
	}
}
