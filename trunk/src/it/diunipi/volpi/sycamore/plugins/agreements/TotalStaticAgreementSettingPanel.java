 ...
 * 
 */
public class TotalStaticAgreementSettingPanel extends SycamorePanel
{
	 ...
	 * Default constructor.
	 */
	public TotalStaticAgreementSettingPanel()
	{
		initialize();
	}
		...
		if (spinner_scale_x == null)
		{
			...
			spinner_scale_x.addChangeListener(new ChangeListener()
			{
				...
				public void stateChanged(ChangeEvent e)
				{
					...
					fireActionEvent(new ActionEvent(TotalStaticAgreementSettingPanel.this, 0, SycamoreFiredActionEvents.UPDATE_AGREEMENTS_GRAPHICS.name()));
				}
			});
		}
		return spinner_scale_x;
